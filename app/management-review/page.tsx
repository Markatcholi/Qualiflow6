      ...
      {reportConfig.equipmentPerformance && (
        <Section title="Equipment Performance" label="EQUIPMENT SYSTEM EFFECTIVENESS" description="Management-level equipment compliance, overdue exceptions, significant equipment events, and quality-system impact. Operational due-soon activity remains on the Equipment dashboard.">
          <div style={gridStyle}>
            ...
            <KpiCard title="Out of Service at Snapshot" value={equipmentOutOfService} color={getStatusColor(equipmentOutOfService, "warning")} />
        ...
        {selectedReview ? (
          ...
          >
            ...
            {selectedApprovers.length === 0 ? (
              ...
              <div style={{ border: "1px solid #bfdbfe", borderRadius: "12px", overflow: "hidden", background: "#eff6ff", marginBottom: "18px" }}>
                <div style={{ padding: "12px 16px", fontWeight: 700, color: "#475569", background: "#dbeafe" }}>
                  ...
                  <tbody>
                    {selectedApprovers.map((approver: any) => {
                      ...
                      const displayStatus =
                        ...
                        "Configured";
                      return (
                        <tr key={`approval-status-${approver.id}`}>
                          <td style={tdStyle}>{approver.approver_role || "Approver"}</td>
                          <td style={tdStyle}>{approver.approver_name || approver.approver_email || "N/A"}</td>
                          <td style={{ ...tdStyle, fontWeight: 700 }}>{displayStatus}</td>
                          <td style={tdStyle}>
